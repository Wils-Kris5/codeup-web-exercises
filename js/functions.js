...
function calculateTip (num1, num2) {
    var tipAmount = num1*num2
    return tipAmount.toFixed(3)
}
/**
 * TODO:
...
alert("your total amount is $" + calculateTip(billTotal,tipPercentage));
