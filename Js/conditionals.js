...
else if(input === 'red') { return 'Strawberries are red';
}
 else if(input === 'cyan') {
...
console.log(analyzeColor('cyan'), 'I don\'t know anything about ' + color);
...
console.log(analyzeColor('red'), 'Strawberries are red');
console.log(analyzeColor('cyan'), 'I don\'t know anything about ' + color);
console.log(analyzeColor('purple'), 'I don\'t know anything about ' + color);
console.log(analyzeColor('green'), 'I don\'t know anything about ' + color);
